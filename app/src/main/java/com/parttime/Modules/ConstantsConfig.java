...
public class ConstantsConfig {
	 ...
	 * 存放发送图片的目录
	 */
	public static String BMOB_PICTURE_PATH = Environment.getExternalStorageDirectory()	+ "/graduation/image/";

	/**
	 * 我的头像保存目录
	 */
	public static String MyAvatarDir = "/sdcard/graduation/headImg/";
	/**
	 * 拍照回调
	 */
